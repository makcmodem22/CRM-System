...
/**
 * Cancels SCHEDULED lessons starting within the next `windowHours` that have ≤1 booking.
 * Refunds the lone booker's subscription session if applicable, deletes their booking,
 * and flips the lesson to CANCELLED. Returns metadata for downstream email notifications.
 */
