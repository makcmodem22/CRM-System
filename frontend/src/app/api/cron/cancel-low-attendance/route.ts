  ...
  await transporter.sendMail({
    ...
    html: `
      <div style="font-family: 'Inter', system-ui, sans-serif; max-width: 600px; margin: 0 auto; color: #1E293B; background-color: #FAFAFA; padding: 40px 20px; border-radius: 16px;">
        ...
        <p style="text-align:center;">Привіт, ${name || 'Гість'}! На жаль, заняття скасовано через недостатню кількість учасників.</p>
        <p style="text-align:center;"><b>${className}</b><br/>${startTime}</p>
